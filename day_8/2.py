...
for name in antennas:
    ...
    for coord1, coord2 in unique_pairs:
        ...
        while left_coord in board_set:
            antinodes.add(left_coord)
            left_coord = (left_coord[0] - left_distance[0], left_coord[1] - left_distance[1])

        right_distance = (coord2[0] - coord1[0], coord2[1] - coord1[1])
        right_coord = (coord1[0] - right_distance[0], coord1[1] - right_distance[1])
        while right_coord in board_set:
            antinodes.add(right_coord)
            right_coord = (right_coord[0] - right_distance[0], right_coord[1] - right_distance[1])
print(len(antinodes))
